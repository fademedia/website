        ...
        >
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center mb-16">
              ...
              <h2 className="mt-6 mb-6 text-4xl lg:text-5xl font-bold font-heading text-zinc-900">
              ...
              <label className="mx-auto  relative flex justify-between items-center group text-xl w-44 h-12 rounded-lg pr-36 pl-1 cursor-pointer">
                <input
                  type="checkbox"
                ...
                />
                <span className="h-8 w-[5.5rem] flex items-center pr-2  after:rounded-lg duration-300 ease-in-out  after:w-[30rem] after:h-10  after:bg-customPrimary   after:shadow-md after:duration-300 peer-checked:after:translate-x-[5.5rem] cursor-pointer"></span>
                <div className="flex absolute text-zinc-900 text-sm font-bold">
                  <div
                    className={
            ...
            <div className="flex flex-wrap flex-col lg:flex-row -mx-4 items-center mt-20">
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div className="p-8  rounded-3xl">
                  <h4 className="mb-2 text-xl font-bold font-heading text-zinc-900 text-left">
                    Beginner
                  </h4>
                  <div className="flex justify-start items-end">
                    <div className="text-4xl sm:text-5xl font-bold text-zinc-900 text-left mt-4 mr-2">
                      $0
                    </div>
              ...
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div className="px-8 py-8 rounded-3xl">
                  <h4 className="mb-2 2xl:mb-4 text-2xl font-bold font-heading text-zinc-900 text-left">
                    Standard
                  </h4>
                  <div className="flex justify-start items-end">
                    <div className="text-4xl sm:text-5xl font-bold text-zinc-900 text-left mt-4 mr-2">
                  ...
                  <ul className="mb-14 text-zinc-900">
                    {pricingData.map((text, index) => (
                      <li className="mb-4 flex" key={`${text}-${index}`}>
                        <CheckArrowIcon />
                        <span>{text}</span>
